/**
 * int配列のデータ地の数だけ＊で棒グラフを表示するprintGraphメソッドを作成せよ
 * 
 * @author 25JZ0148 Yamada taiyou
 * @version 2025/10/20
 */
public class Ex0502Graph {
    ...
    public static void printGraph(int[] ar) {
        ...
        for (int data : ar) {   //データ数回棒グラフを表示する　拡張for文でdataにデータ数を取得
            int n = data;  // データ数をnにコピー
            for (int i = 0; i < n; i++) {  // 棒グラフとしてn個分の*を表示
                System.out.print("*");
            }
            System.out.println(" : " + data);  // 添字とデータ数を表示
...
/*
PS G:\マイドライブ\PG2\PGⅡsrc\Ex05> javac Ex0502Graph.java
PS G:\マイドライブ\PG2\PGⅡsrc\Ex05> java Ex0502Graph      
