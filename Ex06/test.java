...
/*
PS G:\マイドライブ\PG2\PGⅡsrc\Ex06> javac test.java
PS G:\マイドライブ\PG2\PGⅡsrc\Ex06> java test 10 20  33 44  50 60  77 88
座標数 = 4
        ----- Point(int x, int y)
        ----- Point(int x, int y)
        ----- Point(int x, int y)
...
PS G:\マイドライブ\PG2\PGⅡsrc\Ex06> java test 10 22 33
座標数 = 1
        ----- Point(int x, int y)
(10, 22)
PS G:\マイドライブ\PG2\PGⅡsrc\Ex06> java test 10      
引数が足りません
PS G:\マイドライブ\PG2\PGⅡsrc\Ex06> 
 */
